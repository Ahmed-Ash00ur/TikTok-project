...
The primary audience for this project is the TikTok data team, including Rosie Mae Bradshaw (Data Science Manager), Willow Jaffey (Data Science Lead), and Orion Rainier (Data Scientist). A secondary audience includes cross-functional team members like Mary Joanna Rodgers (Project Management Officer) and TikTok executives. Communications will be adapted to be concise and specific for the technical team and clear and high-level for non-technical stakeholders.
...
The project aims to address the large number of user reports on videos and comments, which are currently difficult to review and process quickly. The goal is to develop and deliver a reliable predictive model that can automatically classify user-reported content as either a "claim" or an "opinion." The anticipated impact is a significant reduction in the backlog of user reports, allowing moderators to prioritize their work more efficiently. This will improve the platform's content moderation process, aligning with TikTok's mission to "inspire creativity and bring joy."
